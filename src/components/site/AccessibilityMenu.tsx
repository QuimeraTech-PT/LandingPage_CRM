  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        ...
        >
          <div 
            className="fixed sm:absolute right-4 sm:right-0 top-24 sm:top-full mt-2 w-72 rounded-xl border border-border bg-card p-6 shadow-2xl z-[9999] animate-in fade-in zoom-in duration-200 motion-reduce:animate-none"
