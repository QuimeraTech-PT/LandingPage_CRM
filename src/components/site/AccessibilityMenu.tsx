...
export const AccessibilityMenu = () => {
  ...
  useLayoutEffect(() => {
    ...
    const savedFontSize =
      (localStorage.getItem("a11y-font-size") as "normal" | "large" | "extra") || "normal";
        ...
        {isOpen && (
          <FocusTrap
            focusTrapOptions={{
              ...
              initialFocus: "#accessibility-menu-title",
            }}
          >
            <motion.div
              ref={menuRef}
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2
                  ...
                  tabIndex={-1}
                  className="text-sm font-bold uppercase tracking-wider text-foreground outline-hidden"
                >
                  Acessibilidade
                </h2>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span id="label-contrast" className="text-sm font-medium">
                  ...
                  <p id="desc-contrast" className="text-[10px] text-muted-foreground ml-11">
                    Aumenta o contraste entre o texto e o fundo para melhor legibilidade.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span id="label-motion" className="text-sm font-medium">
                        Movimento Reduzido
                      </span>
                    </div>
                    <button
                  ...
                  <p id="desc-motion" className="text-[10px] text-muted-foreground ml-11">
                    Desativa animações e transições para reduzir o cansaço visual ou enjoo.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span id="label-interactions" className="text-sm font-medium">
                        Micro-interações
                      </span>
                    </div>
                    <button
                  ...
                  <p id="desc-interactions" className="text-[10px] text-muted-foreground ml-11">
                    Controla efeitos visuais como o seguidor do cursor e micro-animações técnicas.
                  </p>
                </div>
                ...
                <div className="space-y-3" role="group" aria-labelledby="label-font-size">
                  <div className="flex items-center gap-3">
                    ...
                    <span id="label-font-size" className="text-sm font-medium">
                      Tamanho da Fonte
                    </span>
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    {(["normal", "large", "extra"] as const).map((size) => (
                      ...
                      >
                        <span
                          className={`font-bold ${size === "normal" ? "text-xs" : size === "large" ? "text-sm" : "text-base"}`}
                        >
                          A
                        </span>
                        <span className="text-[10px] uppercase font-semibold">
                          {size === "normal" ? "Padrão" : size === "large" ? "Grande" : "Extra"}
                        </span>
                      </Button>
                    ))}
                  </div>
