    ...
    (action: string) => {
      const dataLayer =
        typeof window !== "undefined"
          ? (window.dataLayer as FloatingActionEvent[] | undefined)
          : undefined;
          ...
          <>
              ...
              {isOpen && (
                ...
                >
                  <motion.a
                    ...
                    className="flex min-h-12 items-center gap-3 rounded-full bg-[#25D366] px-5 py-2.5 text-white shadow-lg transition-all hover:bg-[#20ba5a] hover:shadow-xl focus-visible:outline-hidden focus-visible:ring-4 focus-visible:ring-[#25D366]/50 focus-visible:ring-offset-2 active:brightness-90 sm:px-4 sm:py-2"
                  >
                  ...
                  <motion.button
                    ...
                    whileHover={shouldReduceMotion ? {} : { scale: 1.05, x: -4 }}
                    whileTap={shouldReduceMotion ? {} : { scale: 0.95 }}
                    className="flex min-h-12 items-center gap-3 rounded-full bg-primary px-5 py-2.5 text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-xl focus-visible:outline-hidden focus-visible:ring-4 focus-visible:ring-primary/50 focus-visible:ring-offset-2 active:brightness-95 sm:px-4 sm:py-2"
                  >
            ...
            <motion.button
              ...
              className={cn(
                ...
                isOpen &&
                  "bg-white text-black dark:bg-card dark:text-foreground border border-border dark:border-white/20 ring-1 ring-border dark:ring-white/10 shadow-md",
              )}
