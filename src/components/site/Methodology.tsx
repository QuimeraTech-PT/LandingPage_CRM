        ...
        >
          {phases.map((phase) => (
            <motion.li
              ...
              role="listitem"
              className="relative flex flex-col rounded-2xl border border-surface-border bg-surface-card p-6 transition-all duration-500 hover:shadow-[0_20px_45px_-28px_rgba(37,99,235,0.4)] hover:-translate-y-2"
