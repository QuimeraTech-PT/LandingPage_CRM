        ...
        >
          ...
          <div className="lg:col-span-5 self-stretch">
            ...
            >
              ...
              <div 
                tabIndex={0}
                className="glass-card group relative flex h-full flex-col overflow-hidden bg-[#0d1117] dark:bg-[#0d1117] light:bg-[#f8f9fa] transition-all duration-500 hover:scale-[1.01] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-hidden rounded-3xl"
                role="article"
