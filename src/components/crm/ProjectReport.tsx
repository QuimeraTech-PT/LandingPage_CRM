...
export function ProjectReport({ project, transactions }: ProjectReportProps) {
  ...
  return (
    <>
      <Button variant="outline" size="sm" className="gap-2 text-xs h-7" onClick={handleDownload}>
        ...
        >
          ...
          <div className="flex justify-between items-start border-b-2 border-primary pb-6 mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium italic">
                Relatório Mensal de Performance e Custos
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div className="space-y-4">
              <h2 className="text-lg font-bold border-l-4 border-blue-600 pl-3">
                Detalhes do Projeto
              </h2>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-bold border-l-4 border-emerald-600 pl-3">
          ...
          {/* Category Breakdown */}
          <div className="mb-8">
            <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-900 pl-3">
                ...
                {Object.keys(expensesByCategory).length === 0 && (
                  <tr>
                    <td colSpan={4} className="py-10 text-center text-slate-400 italic">
                      Nenhuma despesa registada para este projeto.
                    </td>
                  </tr>
                )}
              </tbody>
          ...
          <div className="mt-auto border-t border-slate-100 pt-6 flex justify-between items-end opacity-60">
            <div className="text-[10px] text-slate-400 max-w-[60%]">
              ...
              <p>
                Este relatório contém informações financeiras confidenciais proprietárias da
                QuimeraTech. O acesso não autorizado ou a partilha sem consentimento é estritamente
                proibida.
              </p>
            </div>
