...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      crm_contract_status: "draft" | "sent" | "signed" | "active" | "expired" | "cancelled";
      crm_lead_status:
        "new" | "contacted" | "proposal" | "negotiation" | "closed_won" | "closed_lost";
      crm_project_status: "planning" | "active" | "on_hold" | "completed" | "cancelled";
      crm_proposal_status:
        "draft" | "sent" | "viewed" | "negotiation" | "accepted" | "rejected" | "expired";
      crm_task_status: "todo" | "in_progress" | "blocked" | "review" | "done";
      crm_ticket_status: "open" | "in_progress" | "waiting_client" | "resolved" | "closed";
...
export const Constants = {
  public: {
    Enums: {
      ...
      crm_company_status: ["active", "inactive", "prospective"],
      crm_contract_status: ["draft", "sent", "signed", "active", "expired", "cancelled"],
      crm_lead_status: ["new", "contacted", "proposal", "negotiation", "closed_won", "closed_lost"],
      crm_project_status: ["planning", "active", "on_hold", "completed", "cancelled"],
      crm_proposal_status: [
        "draft",
        "sent",
